...
public class MenuPrincipal extends javax.swing.JFrame {
    ...
    private void BotonCerrarSesionMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BotonCerrarSesionMouseClicked
        ...
        if (opcionSalir == JOptionPane.YES_OPTION) {
            Main_Sequence.gestorUsuarios.setUsuarioLog(null);
    ...
    private void BotonJugarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BotonJugarMouseClicked
        if (Main_Sequence.gestorUsuarios.getConfiguracionUsuario().getCantidadJugadores() == 0 || Main_Sequence.gestorUsuarios.getConfiguracionUsuario().getColorFicha() == null) {
            JOptionPane.showMessageDialog(null, "Por favor, configura la partida antes de comenzar.", "Configuración de la Partida", JOptionPane.INFORMATION_MESSAGE);
            return;
        }
